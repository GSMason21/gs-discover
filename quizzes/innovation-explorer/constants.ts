import { Question, PersonaProfile, QuizConfig } from '../../shared/types';
...
export const QUESTIONS: Question[] = [
  { id: 1, category: 'INNOVATION', text: 'Primary Learning Goal', options: [
  ...
  { id: 2, category: 'INNOVATION', text: 'The Role of the Learner', options: [
  ...
  { id: 3, category: 'INNOVATION', text: 'The Definition of "Classroom"', options: [
  ...
  { id: 4, category: 'INNOVATION', text: 'Evidence of Success', options: [
  ...
  { id: 5, category: 'INNOVATION', text: 'Design Focus', options: [
  ...
  { id: 6, category: 'COHERENCE', text: 'The "North Star" (Mission & Vision)', options: [
  ...
  { id: 7, category: 'COHERENCE', text: 'Adult Alignment', options: [
  ...
  { id: 8, category: 'COHERENCE', text: 'Signaling Consistency', options: [
  ...
  { id: 9, category: 'COHERENCE', text: 'Scalability of Innovation', options: [
  ...
  { id: 10, category: 'COHERENCE', text: 'Strategic Pacing', options: [
...
export const PERSONAS: Record<string, PersonaProfile> = {
  DRIFTER: {
    id: 'DRIFTER', name: 'The Drifter', subtitle: 'Low Innovation / Low Coherence',
    color: 'bg-slate-400',
  ...
  SENTRY: {
    id: 'SENTRY', name: 'The Sentry', subtitle: 'Low Innovation / High Coherence',
  ...
  TRAILBLAZER: {
    id: 'TRAILBLAZER', name: 'The Trailblazer', subtitle: 'Medium Innovation / Low Coherence',
    color: 'bg-orange-500',
  ...
  SURVEYOR: {
    id: 'SURVEYOR', name: 'The Surveyor', subtitle: 'Medium Innovation / High Coherence',
    color: 'bg-teal-600',
  ...
  SCOUT: {
    id: 'SCOUT', name: 'The Scout', subtitle: 'High Innovation / Low Coherence',
  ...
  WAYFINDER: {
    id: 'WAYFINDER', name: 'The Wayfinder', subtitle: 'High Innovation / High Coherence',
    color: 'bg-amber-600',
